...
@csrf
                  ...
                  <div class="form-label-group p-2 m-2 text-right">
                    <label for="inputEmail" class=" text-secondary"> : العمر </label>
                      ...
                      <select name="age" id="inputEmail" class=" text-dark form-control form-control-lg text-right" >
                  ...
                  <div class="form-label-group p-2 m-2 text-right">
                    <label for="inputEmail" class=" text-secondary"> : المستوى الدراسي </label>
                      ...
                      <select name="niveau" id="inputEmail"   class="  text-dark form-control form-control-lg text-right" >
    ...
    <optgroup label="__________________">
                  ...
                  <div class="form-label-group p-2 m-2 text-right">
                    <label for="inputEmail" class=" text-secondary">   :   التسجيل في دورة   </label>
                      ...
                      <select name="formation" id="inputEmail"   class="  text-dark form-control form-control-lg text-right"  >
